...
\item[Line 2] Since this test is dependent of \lstinline|testCreateUser()| it takes the \lstinline|userId| that \lstinline|testCreateUser()| returns as a parameter.

...
First time you are using the application, you will be encoutered by a screen telling you to scan an \ac{nfc} tag, this is shown on \autoref{fig:nfcscreen}. After having scanned the tag for the first time you are promoted with a screen asking you to choose the categories, this is to identify your interests. This is shown on \autoref{fig:categories}. After having selected your categories, you press submit.

This chapter describes the initial design of our application,  the requirements we found based on the prototypes that we made and finally it describes our final design.\todo{Other things than the application?}
